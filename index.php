...
class Movie
{
    ...
    public function __construct($id, $title, $genre, $year, $description, $vote = '')
    {
        $this->id = $id;
        $this->title = $title;
        $this->genre = $genre;
